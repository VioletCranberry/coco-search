# Requirements Archive: v1.4 Dogfooding Infrastructure
...
**Adjusted:**
- DEVS-03/DEVS-04: Changed from native Ollama detection to Docker-only for consistency
- DEVS-08: Changed from colored output to plain text with prefixes for CI compatibility
