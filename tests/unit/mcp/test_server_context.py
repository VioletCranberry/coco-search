...
class TestContextParameterCombinations:
    ...
    @pytest.mark.asyncio
    async def test_context_before_only(
        self, mock_code_to_embedding, mock_db_pool, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_context_after_only(
        self, mock_code_to_embedding, mock_db_pool, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_both_context_before_and_after(
        self, mock_code_to_embedding, mock_db_pool, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_smart_context_false_no_counts(
        self, mock_code_to_embedding, mock_db_pool, tmp_path
    ):
...
class TestContextEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_file_not_found_graceful_handling(
